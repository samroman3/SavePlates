...
class LoginViewController: UIViewController {
  ...
  lazy var logoLabel: UILabel = {
    ...
    let attributedTitle = NSMutableAttributedString(string: "Save Plates", attributes: [NSAttributedString.Key.font: UIFont(name: "Trebuchet MS", size: 70)!])
  ...
  lazy var emailIcon: UIImageView = {
    ...
    icon.tintColor = UIColor(displayP3Red: 13/255, green: 92/255, blue: 99/255, alpha: 1)
  ...
  lazy var loginButton: UIButton = {
    ...
    button.setTitleColor(UIColor(displayP3Red: 13/255, green: 92/255, blue: 99/255, alpha: 1), for: .normal)
  ...
  private func setupLogoLabel() {
    ...
    NSLayoutConstraint.activate([
      logoLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 50), logoLabel.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 16),
      logoLabel.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -16)])
  }
  ...
  private func setupLoginStackView() {
    ...
    NSLayoutConstraint.activate([stackView.topAnchor.constraint(equalTo: logoLabel.safeAreaLayoutGuide.bottomAnchor),
  ...
  private func setupEmailIcon(){
    ...
    NSLayoutConstraint.activate([
      emailIcon.trailingAnchor.constraint(equalTo: emailTextField.safeAreaLayoutGuide.leadingAnchor, constant: -10),
      emailIcon.centerYAnchor.constraint(equalTo: emailTextField.safeAreaLayoutGuide.centerYAnchor),
  ...
  private func setupPasswordIcon(){
    ...
    NSLayoutConstraint.activate([
      passwordIcon.trailingAnchor.constraint(equalTo: passwordTextField.safeAreaLayoutGuide.leadingAnchor, constant: -10),
      passwordIcon.centerYAnchor.constraint(equalTo: passwordTextField.safeAreaLayoutGuide.centerYAnchor),
  ...
  private func setUpLoginButton(){
    ...
    NSLayoutConstraint.activate([
      loginButton.topAnchor.constraint(equalTo: passwordTextField.safeAreaLayoutGuide.bottomAnchor, constant: 30), loginButton.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -80),
      loginButton.heightAnchor.constraint(equalToConstant: 70),
      loginButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 80)])
    view.layoutIfNeeded()
